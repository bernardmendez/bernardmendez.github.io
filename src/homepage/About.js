    ...
    <div className='About'>
     ...
     <div id='meat'>
       ...
       <h2>About Bernard Mendez</h2>
        <p>
          Good <b>{time_of_day}</b>. I am a journalist based out of the Los Angeles and Orange County area. I currently attend UCLA, where I study applied mathematics.
        </p>
        <p>
        ...
        <p>
          Feel free to reach out to me at my email, bhmendez@protonmail.com, or via my Twitter, @bernardhmendez.
        </p>
        <p><i>**This site is still under construction</i></p>
